...
from modules.repair_engine import (
    ...
    show_flip_impact_analysis,
    show_repair_score_report,
    show_top_repair_candidates
...
# ==================================================
    ...
    venue_slots, venue_groups = build_venue_config(venue_config_file)
...
# ==================================================
    ...
    return_fixture_report = show_return_fixture_finder(
        df,
        overload_games,
        over_capacity
    )
...
# --------------------------------------------------
    ...
    flip_candidate_report = show_flip_candidate_detection(
...
# --------------------------------------------------
    ...
    impact_report = show_flip_impact_analysis(
...
# --------------------------------------------------
    ...
    repair_score_report = show_repair_score_report(
        impact_report,
        over_capacity
    )
...
# --------------------------------------------------
    ...
    top_candidates = show_top_repair_candidates(
        repair_score_report,
        over_capacity
    )
